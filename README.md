...
Markers do not modify stored messages or model context. Markdown that begins with a block construct receives its marker on a separate line so the original Markdown remains valid.
