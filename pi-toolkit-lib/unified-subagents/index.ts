...
import { AGENT_HARNESSES, type AgentConfig, type AgentInvocation, type AgentMentionMode, type AgentRecord, type JoinMode, type NotificationDetails, type SubagentType, type WidgetMode } from "./types.js";
...
export function registerUnifiedSubagents(pi: ExtensionAPI): void {
  ...
  const spawnTopLevel = (piRef: any, ctxRef: ExtensionContext, type: string, prompt: string, options: any) => {
    ...
    for (const key of [
      "parentAgentId", "depth", "maxSubagentDepth", "configCwd", "rootSessionId",
      "resumeSessionFile", "reclaim", "trusted", "agentConfig", "modelHint",
      "invocation", "bypassQueue", "signal", "onToolActivity", "onTextDelta",
