...
import {
  ...
  isEmptyStub,
  locateAgentFile,
} from "../../pi-toolkit-lib/unified-subagents/agent-file-toggle.js";
import { parseAgentFrontmatter } from "../../pi-toolkit-lib/unified-subagents/custom-agents.js";
...
describe("disableInContent", () => {
  ...
  it("toggles a BOM-prefixed file without moving or removing the BOM", () => {
    const src = "﻿---\ndescription: 侦察\n---\n\n本文。\n";
    const { content, outcome } = disableInContent(src);
...
describe("parseAgentFrontmatter", () => {
  it("reads BOM-prefixed fields rather than treating the whole file as body", () => {
    const src = "﻿---\ndescription: 侦察\ntools: none\n---\n\n本文。\n";
  ...
  it("leaves non-BOM input exactly to pi's parser", () => {
    const src = "---\ndescription: Scout\n---\n\nBody.\n";
