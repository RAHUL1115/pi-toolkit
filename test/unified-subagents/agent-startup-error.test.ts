...
vi.mock("../../pi-toolkit-lib/unified-subagents/worktree.js", async () => {
  const actual = await vi.importActual<typeof import("../../pi-toolkit-lib/unified-subagents/worktree.js")>("../../pi-toolkit-lib/unified-subagents/worktree.js");
