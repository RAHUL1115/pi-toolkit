...
vi.mock("../../pi-toolkit-lib/unified-subagents/output-file.js", async () => {
  const actual = await vi.importActual<typeof import("../../pi-toolkit-lib/unified-subagents/output-file.js")>("../../pi-toolkit-lib/unified-subagents/output-file.js");
  return {
    ...actual,
...
import { ensureOutputFile, streamToOutputFile, writeInitialEntry } from "../../pi-toolkit-lib/unified-subagents/output-file.js";
