...
// Creating symlinks requires Windows Developer Mode or elevated privileges.
...
import { buildMemoryBlock, buildReadOnlyMemoryBlock, ensureMemoryDir, isSymlink, isUnsafeName, readMemoryIndex, resolveMemoryDir, safeReadFile } from "../../pi-toolkit-lib/unified-subagents/memory.js";
...
describe("memory", () => {
  ...
  describe("ensureMemoryDir", () => {
    ...
    symlinkIt("throws on symlinked directory", () => {
  ...
  describe("isSymlink", () => {
    ...
    symlinkIt("returns true for symlink", () => {
  ...
  describe("safeReadFile", () => {
    ...
    symlinkIt("rejects symlinked files", () => {
      const file = join(tmpDir, "real.txt");
      const link = join(tmpDir, "link.txt");
  ...
  describe("readMemoryIndex", () => {
    ...
    symlinkIt("rejects symlinked memory directory", () => {
    ...
    symlinkIt("rejects symlinked MEMORY.md file", () => {
  ...
  describe("buildReadOnlyMemoryBlock", () => {
    ...
    symlinkIt("rejects symlinked memory directory in read-only mode", () => {
