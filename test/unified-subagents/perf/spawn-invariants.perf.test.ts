...
vi.mock("../../../pi-toolkit-lib/unified-subagents/custom-agents.js", async () => {
  const actual = await vi.importActual<typeof import("../../../pi-toolkit-lib/unified-subagents/custom-agents.js")>("../../../pi-toolkit-lib/unified-subagents/custom-agents.js");
  return {
    ...actual,
