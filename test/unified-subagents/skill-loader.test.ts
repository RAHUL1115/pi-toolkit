...
import { preloadSkills } from "../../pi-toolkit-lib/unified-subagents/skill-loader.js";
...
describe("preloadSkills", () => {
  ...
  it.skipIf(process.platform === "win32")("rejects symlinked flat .md files", () => {
  ...
  it.skipIf(process.platform === "win32")("rejects symlinked skill root", () => {
  ...
  it.skipIf(process.platform === "win32")("rejects symlinked SKILL.md inside a real skill directory", () => {
