...
import { appendJournal, journalKey, readJournal, type WorkflowJournalEntry } from "../../pi-toolkit-lib/unified-subagents/workflow/journal.js";
import { runWorkflow, type WorkflowSpawnRequest, type WorkflowSpawnResult } from "../../pi-toolkit-lib/unified-subagents/workflow/runtime.js";
...
describe("journalKey", () => {
  ...
  it("separates calls that differ only in how the agent was configured", () => {
    ...
    const keys = new Set([
      ...
      journalKey({ ...base, harness: "claude" }),
