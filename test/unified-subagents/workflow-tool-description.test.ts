...
import { fullWorkflowToolDescription } from "../../pi-toolkit-lib/unified-subagents/workflow/tool-description.js";

const description = fullWorkflowToolDescription;
const workerSource = readFileSync(
  fileURLToPath(new URL("../../pi-toolkit-lib/unified-subagents/workflow/worker-source.ts", import.meta.url)),
  "utf8",
);
